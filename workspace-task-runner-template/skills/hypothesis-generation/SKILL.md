...
description: |
  Structured hypothesis formulation from observations — formulate testable hypotheses with predictions, propose mechanisms, and design experiments.
---

# NOTE: Adapted from LabClaw (github.com/wu-yc/LabClaw) for OpenClaw task-runner.
# Original: skills/general/hypothesis-generation/SKILL.md
# scientific-schematics skill referenced for visualization — may not be available in task-runner.
# Use matplotlib/seaborn as fallback for figure generation.
