...
# rollback-snapshot-post-slice.sh
# Purpose: Single-command rollback for snapshot_post live activation
# Usage:   sudo bash scripts/rollback-snapshot-post-slice.sh <artifacts-dir>
#
...
if [[ $# -lt 1 ]]; then
    ...
    echo "" >&2
    echo "The artifacts-dir is the directory created by activate-snapshot-post-slice.sh," >&2
    echo "typically: artifacts/phase2/snapshot-post-live-activation-YYYYMMDD-HHMM" >&2
    exit 1
fi
...
# snapshot_post slice rollback result
