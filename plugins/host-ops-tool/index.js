...
//         registerTool-based tool registration implemented (gateway_health + validate_openclaw_json_candidate + deploy_openclaw_json_candidate + snapshot_pre + snapshot_post)
...
//
// Fail-closed policy:
//   - Only ENABLED_ACTIONS are permitted (currently: gateway_health, validate_openclaw_json_candidate, deploy_openclaw_json_candidate, snapshot_pre, snapshot_post)
...
const ENABLED_ACTIONS = ["gateway_health", "validate_openclaw_json_candidate", "deploy_openclaw_json_candidate", "snapshot_pre", "snapshot_post"];
...
export function hostOpsToolSkeleton() {
  return {
    ...
    note: "register(api) calls api.registerTool with optional:true. Tool supports gateway_health, validate_openclaw_json_candidate, deploy_openclaw_json_candidate, snapshot_pre, and snapshot_post. Agent-facing activation requires tools.allow to include host_ops.",
...
function createHostOpsTool() {
  return {
    ...
    description:
      ...
      "Currently supported actions: gateway_health, validate_openclaw_json_candidate, deploy_openclaw_json_candidate, snapshot_pre, snapshot_post.",
    parameters: {
      type: "object",
      properties: {
        action: {
          ...
          description:
            ...
            "Currently supported: gateway_health, validate_openclaw_json_candidate, deploy_openclaw_json_candidate, snapshot_pre, snapshot_post.",
        },
        inputs: {
          type: "object",
          properties: {
            ...
            reason: {
              type: "string",
              description:
                "Reason for the operation (required for snapshot_pre, snapshot_post).",
            },
            candidate_path: {
              type: "string",
              description:
          ...
          description:
            ...
            "(needs candidate_path, expected_sha256). Required for snapshot_pre and snapshot_post (needs label, reason). Not needed for gateway_health.",
        },
      },
      required: ["action"],
