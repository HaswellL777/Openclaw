...
broker_emit_result \
  "{\"candidate_path\":\"$CANDIDATE_PATH\",\"expected_sha256\":\"$EXPECTED_SHA256\",\"sha256_match\":null,\"json_valid\":null,\"schema_valid\":null}" \
  "[STUB] Validation — no live execution in Phase 2 prep" \
